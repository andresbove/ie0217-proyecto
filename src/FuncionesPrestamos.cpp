...
void sacarPrestamo(string moneda, string tipo) {
    ...
    if (verificacion == false) {
        ...
        if (moneda == "CRC")
        {
            ...
            pstmt->setInt(1, prestamo.cedula); // Ejemplo de cédula
            ...
            pstmt->setDouble(7, prestamo.interesAnual); // Ejemplo de interés anual
            ...
            pstmt2->setInt(2, prestamo.cedula); // Cédula del cliente
...
void pagarPrestamoColones(string tipo) {
    ...
    if (efectivo == true) {
        ...
        if (pagocolones) {
            ...
            pstmt2->setInt(3, cedula); // Cédula específica
            pstmt2->setString(4, tipo); // Tipo específico
