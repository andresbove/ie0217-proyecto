 ...
 * Aqui es donde están definidas las funciones para el manejo del menú.
*/
#include "header.hpp"

/**
 * Encargado del menú inicial.
*/
void menuPrincipal() {
    int opcion;
    do {
...
/**
 * Encargado del menú de transacciones.
*/
...
/**
 * Encargado del menú del tipo de préstamo.
*/
...
/**
 * Encargado del menú de sacar préstamos.
*/
    ...
    do {
        ...
        try {
            ...
            case 1:
                ...
                // L�gica para sacar pr�stamo espec�fico en d�lares
                sacarPrestamo("USD", tipoPrestamo);
                break;
            case 2:
                cout << "Ha seleccionado sacar prestamo " << tipoPrestamo << " en Colones." << endl;
                // L�gica para sacar pr�stamo espec�fico en colones
...
/**
 * Menu para poder pagar préstamos ya sea en CRC o USD.
*/
    ...
    do {
        ...
        try {
            ...
            case 1:
                ...
                // L�gica para pagar pr�stamo en d�lares
            ...
            case 2:
                ...
                cin >> tipo;
                toUpperCase(tipo);
                // L�gica para pagar pr�stamo en colones
...
/**
 * Encargado del menú para poder realizar depósitos.
*/
void menuDepositar() {
    int opcion;
    do {
        ...
        try {
            ...
            case 1:
                ...
                // L�gica para depositar en d�lares
                depositar("USD");
                break;
            case 2:
                cout << "Ha seleccionado depositar en Colones." << endl;
                // L�gica para depositar en colones
                depositar("CRC");
                break;
            case 3:
                menuAtencionCliente();
    ...
    do {
        ...
        try {
            ...
            case 1:
                ...
                // L�gica para transferir en d�lares
                transferir("USD");
                break;
            case 2:
                cout << "Ha seleccionado transferir en Colones." << endl;
                // L�gica para transferir en colones
                transferir("CRC");
                break;
            case 3:
                menuAtencionCliente();
    ...
    do {
        ...
        try {
            ...
            case 1:
                ...
                // L�gica para retirar en d�lares
                retirar("USD");
                break;
            case 2:
                cout << "Ha seleccionado retirar en Colones." << endl;
                // L�gica para retirar en colones
                retirar("CRC");
                break;
            case 3:
                menuAtencionCliente();
...
/**
 * Menu para ver información acerca de los préstamos del cliente.
*/
    ...
    do {
        ...
        try {
            ...
            case 1:
                ...
                // L�gica para informaci�n de pr�stamo personal
                break;
            case 2:
                cout << "Ha seleccionado Prestamo Prendario." << endl;
                // L�gica para informaci�n de pr�stamo prendario
